...
```{r  total-synth, fig.cap = "Difference in centered and scaled standardized targeted abundance and synthetic standardized targeted abundance", eval=FALSE}
total_gap_plot
```
...
```{r synth-classcode-fits, fig.cap="Synthetic control gaps for each targeted species", eval=FALSE}
synth_classcode_fits_plot + 
  theme_minimal()
```
