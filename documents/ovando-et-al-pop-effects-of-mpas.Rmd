...
knitr::kable(equations,
             escape = FALSE,
             caption = "Variables for MPA simulations. U mean uniform",
             format = "pipe") %>% 
