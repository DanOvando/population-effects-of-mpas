...
Our simulations and difference-in-difference model examine percentage changes in biomass densities (as opposed to changes in total population size). An increase in biomass densities from 0.02kg/m^2^ to 0.04kg/m^2^ would be measured as a 100% increase. While a large percentage effect, this is a small change in biomass densities relative to the variance in the observation process itself. While an MPA providing 25% protection might be expected to produce a 30% increase in biomass densities, expressed as a percentage of unfished biomass, this gain is on the order of 15% (Fig.SXX). In addition, the median estimated age at sexual maturity for the targeted species included in this study is `r median_tm` years, meaning that the span of this analysis represents less than three generations of MPA protection for half of the measured species. Ongoing monitoring may yet reveal clearer effects, especially if the time series extends beyond the periods of environmental shocks. Analysis of more rapidly growing and maturing species, e.g. spiny lobster, may also reveal clearer signals.
