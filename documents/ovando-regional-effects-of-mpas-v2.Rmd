...
Numerous factors can affect the regional effects of MPAs. These include the scale of adult and larval dispersal relative to the size of the MPAs  [@gaines2003; @botsford2008; @difranco2018;@mcgilliard2008], larval dispersal patternss and the strength and timing of density dependence in the population (e.g. pre- or post-settlement, @burgess), how overfished the population would be without the MPA, and how fishing and management responds to the implementation of the MPAs [@hilborn2004; @hilborn1992; @walters2004; @hastings2003;@gerber2003; @gerber2005; @hilborn2004a; @gaines2010; @botsford2003;@smith2003;@smith2006]. In addition, even for the same total area of MPAs, the location and spacing of the MPAs can have a profound influence on their cumulative impact through habitat and network effects [@gaines2010; @costello2010].
...
Given this existing body of theory, what should we expect *a priori* the effect size of the Channel Islands MPAs to be? The species are xx. We utilize a spatial bio-econonomic model to simulate the expected effects of an MPA network stylized to resemble the Channel Islands (See SI for details of simulation framework). For this group, MPA theory suggests that regional effects on the order of XX% are reasonable for such a system. 

Although the Islands do not encompass the full population of any of these species, they encompass a large enough area to assess the regional MPA conservation effects we might see in the Channel Islands after 14 years of protection (the time span covered by our model).  The median regional conservation effect produced by our simulation model after 13 years of protection by MPAs covering between 15%-20% of a population's range was `r percent(med_ci_effect, accuracy = 1)`. This projected effect has an an interquartile range of `r percent(quart_ci_effect[2], accuracy = 1)` and `r percent(quart_ci_effect[4], accuracy = 1)`, although values as high as a 200% increase and as low as a 50% decrease were also produced. Our expectation then is that all else being equal we are likely looking for a modest but positive effect size.
...
What evidence do we have  for the effects of the Channel Island MPAs? @caslle2015 examined changes in biomass densities of species targeted by fishing activity inside and outside of the MPAs over time (generally termed "response ratios"), and compared these changes to the trends in non-targeted species. They found a statistically significant increase in the response ratios of targeted speices over time, and evidence that this increase is smaller in the non-targeted species. Updating the results of @caselle2015 through 2018 shows a continuation of this trend (Fig.\@ref(fig:XX)). 
...
Using this model, we estimate... XX. As we might expect from bio-economic modeling, we detect no significant difference between targeted and non-targeted biomass densities for the first XX years of protection. However, over time the model assigns greater and greater probability to MPA-mediated increases in targeted fin-fish biomass densities, up until XX, at which point th trend reverses itself. We detect no significant MPA effect between 2015 and 2018 (Fig.\@ref(fig:)). 
